							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?=$ff1?>"><a href="#" ><i class="icon-stack2"></i> <span>CONTROLS</span></a>
									<ul>
										...
										<li class="<?=$f4?>"><a href="<?= base_url('consultant/procedure') ?>">Procedures and Manuals</a></li>
										<li class="<?=$f5?>"><a href="<?= base_url('consultant/record') ?>">Forms and Formats</a></li>
									</ul>
								</li>
								<li class="<?=$bb1?>">
										...
										<li class="<?=$c6?>">
											...
											<ul>
												<li class="<?=$c61?>">
													...
													<ul>
														<li class="<?=$c611?>"><a href="<?= base_url('') ?>consultant/risks_opportunities"><span>Risks And Opportunities</span></a></li>
